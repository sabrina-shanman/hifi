...
FBXBaker::FBXBaker(const QUrl& inputModelURL, const QString& bakedOutputDirectory, const QString& originalOutputDirectory, const QUrl& destinationPath, bool hasBeenBaked) :
        ModelBaker(inputModelURL, bakedOutputDirectory, originalOutputDirectory, destinationPath, hasBeenBaked) {
    if (hasBeenBaked) {
