...
public:
    using Input = baker::VaryingSet5<baker::VerticesPerMesh, baker::MeshPartsPerMesh, std::vector<baker::IndicesPerBlendshape>, std::vector<baker::VerticesPerBlendshape>, std::vector<baker::NormalsPerBlendshape>>;
