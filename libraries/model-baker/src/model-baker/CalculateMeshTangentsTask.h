...
public:
    ...
    using Input = baker::VaryingSet6<baker::MeshPartsPerMesh, baker::VerticesPerMesh, baker::NormalsPerMesh, baker::TangentsPerMesh, baker::TexCoordsPerMesh, QHash<QString, hfm::Material>>;
